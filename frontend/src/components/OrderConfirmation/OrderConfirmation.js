...
const OrderConfirmation = () => {
    ...
    return (
        <div className='container'>
            <div className="order-confirmation-container" data-testid="order-confirmation">
                {renderComponent()}
                <button data-testid="home-button" className='home-button' type='button' onClick={handleGoHome}>Back to Home</button> 
            </div>
        </div>
    );
};
